...
<div class="page-banner shop-banner container-fluid no-padding">
    <div class="banner-content">
        ...
        <ol class="breadcrumb">
            ...
            <li><i><img src="img/banner.png" alt="banner"></i></li>
        ...
        <div class="content-area col-md-12 col-sm-12 col-xs-12">
            <ul class="products">
                ...
                <li class="product">							
                    <a href="shop-detail.html" title="Prouct">
                        <div class="product-img-box">
                            <img src="img/menu-5.png" alt="menu" />
                        </div>
                        <div class="detail-box">
                            <h3>Cherries</h3>
                            <i class="fa fa-star"></i>
                ...
                <li class="product">							
                    <a href="shop-detail.html" title="Prouct">
                        <div class="product-img-box">
                            <img src="img/menu-9.png" alt="menu" />
                        </div>
                        <div class="detail-box">
                            <h3>Skittles</h3>
                            <i class="fa fa-star"></i>
                ...
                <li class="product">							
                    <a href="shop-detail.html" title="Prouct">
                        <div class="product-img-box">
                            <img src="img/menu-6.png" alt="menu" />
                        </div>
                        <div class="detail-box">
                            <h3>Watermelons</h3>
                            <i class="fa fa-star"></i>
                ...
                <li class="product">							
                    <a href="shop-detail.html" title="Prouct">
                        <div class="product-img-box">
                            <img src="img/menu-13.png" alt="menu" />
                        </div>
                        <div class="detail-box">
                            <h3>Skittles</h3>
                            <i class="fa fa-star"></i>
                ...
                <li class="product">							
                    <a href="shop-detail.html" title="Prouct">
                        <div class="product-img-box">
                            <img src="img/menu-14.png" alt="menu" />
                        </div>
                        <div class="detail-box">
                            <h3>Jelly Beans</h3>
                            <i class="fa fa-star"></i>
                ...
                <li class="product">							
                    <a href="shop-detail.html" title="Prouct">
                        <div class="product-img-box">
                            <img src="img/menu-15.png" alt="menu" />
                        </div>
                        <div class="detail-box">
                            <h3>Lemon Drops</h3>
                            <i class="fa fa-star"></i>
