    ...
    <main>
        ...
        <div class="home-about-section container-fluid">
            ...
            <div class="container">
                ...
                <div class="about-content">
                    ...
                    <img src="img/about-bg.png" alt="about-bg">
                </div>
            </div><!-- Container /- -->
        ...
        <div class="product-section woocommerce container-fluid">
            ...
            <div class="container">
                ...
                <ul class="products">
                    <li class="product">							
                        <a href="shop-detail.html" title="Prouct">
        ...
        <!-- Testimonial Section -->
        <div id="testimonial-section" class="testimonial-section container-fluid">
            <!-- Container -->
            <div class="container">
                <!-- Section Header -->
                <div class="section-header">
                ...
                <div id="main-carousel1" class="carousel slide carousel-fade" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <li data-target="#main-carousel1" data-slide-to="0" class=""></li>
                        <li data-target="#main-carousel1" data-slide-to="1" class="active"></li>
                        <li data-target="#main-carousel1" data-slide-to="2"></li>
                    </ol>
                    <div role="listbox" class="carousel-inner">
                        <div class="item active">
                            <div class="testimonial-content">
                                <p>Nemo enim ipsam voluptatem quia voluptas sitodit aut fugit, consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. quisquam dolorem.</p>
                                <i class="fa fa-quote-right" aria-hidden="true"></i>
                                <img src="img/testi-1.jpg" alt="testi">
                                <div class="customer-intro">
                                    <img src="img/testi-seprator-1.png" alt="testi-seprator">
                                    <h3>Williom son</h3>
                                    <span>Customer</span>
                                    <img src="img/testi-seprator-2.png" alt="testi-seprator">
                                </div>
                            </div>
                        </div>
                        <div class="item">
            ...
            <div class="container">
                ...
                <div class="contact-us col-md-8">
                    <form>
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="4" name="contact-message" id="textarea_message" placeholder="Enter your message here...." ></textarea>
                        </div>
                        <div class="form-group">
                            <button title="Send Message" id="btn_submit" name="post">Send Message</button>
                        </div>
